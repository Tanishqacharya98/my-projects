...
function Header({ onNote }) {
	...
	const userImage = userDetails?.user?.profilePicture || "";
							...
							<ul className="navbar-nav header-right">
								...
								<li className="nav-item dropdown header-profile">
									<Link className="nav-link" to={"#"} role="button" data-bs-toggle="dropdown">
										<img
											src={userImage ? `http://localhost:5000/${userImage}` : IMAGES.user}
											width="20"
											alt="user"
										/>									<div className="header-info ms-3">
											<span className="fs-14 font-w600 mb-0">{userName}</span>										</div>{SVGICON.threeline}
									</Link>
										...
										<div className="card-body p-0">
											<div className="d-flex profile-media justify-content-between align-items-center">
												<div className="d-flex align-items-center">
													<img
														src={userImage ? `http://localhost:5000/${userImage}` : IMAGES.kprofile}
														alt="img"
													/>												<div className="ms-3">
											...
											<div className="media-box">
												<ul className="d-flex flex-colunm gap-2 flex-wrap">
													...
													<li>
														<div className="icon-box-lg" onClick={handleLogout} style={{ cursor: "pointer" }}>
															{SVGICON.logout}
															<p>Logout</p>
														</div>
													</li>
